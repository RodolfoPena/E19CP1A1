...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post workers_url, params: { worker: { first_name: @worker.first_name, last_name: @worker.last_name } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { first_name: @worker.first_name, last_name: @worker.last_name } }
